...
document.getElementById("submitlink").addEventListener("click", function(event) {
    ...
    <section class="section-1" id="sec1">
      ...
      <div class="form-create">
        ...
        <!--Form-->
        <div class="cform">
         <div class="banner>"><h1>In order to find services you have to login!</h1></div>
         <p>To see Customer Services you have to login as user and to see Vendor Services you have to log in as vendor.</p>
