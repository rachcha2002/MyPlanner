	...
	<div class="container">
		<table class="table table-striped table-bordered">
			...
			<h2>Profile Details</h2>
				...
				<tr>
					<td colspan="2" class="text-center"><c:url
							value="updateclient.jsp" var="clientupdate">
						...
						</c:url> <a href="${clientupdate}" class="btn btn-primary">Update</a> <c:url
							value="deleteclient.jsp" var="clientdelete">
							<c:param name="id" value="${client.id}" />
							<c:param name="name" value="${client.name}" />
							<c:param name="gender" value="${client.gender}" />
							<c:param name="dob" value="${client.dob}" />
							...
							<c:param name="username" value="${client.username}" />
							<c:param name="password" value="${client.password}" />
						</c:url> <a href="${clientdelete}" class="btn btn-danger">Delete</a></td>
				</tr>
			</c:forEach>
		</table>
	</div>
