...
<html>
<head>
    <title>Booking a Consultation</title>
...
<% 
			...
			%>
   <div class="container">
    <h2>Booking a Consultation Form</h2>
    <form action="bookingevent" method="post">
        <div class="form-group">
            <label for="rname">Reservation Name:</label>
            <input type="text" class="form-control" id="rname" name="rname" required>
        </div>
        <div class="form-group">
            <label for="venue">Preffered Venue</label>
