...
document.getElementById("submitlink").addEventListener("click", function(event) {
    ...
    <c:param name='client_username' value='${booking.client_username}'/>
    <c:param name='rname' value='${booking.rname}'/>
    <c:param name='venue' value='${booking.venue}'/>
    <c:param name='edate' value='${booking.edate}'/>
    <c:param name='etime' value='${booking.etime}'/>
</c:url>" class="btn btn-primary btn-sm"style="width: 100px; height: 30px;">Edit</a>
                            
                            
                            <form action="deletebooking.jsp" method="post">
                            <input type="hidden" name="booking_id" value="${booking.booking_id}">
                            <button type="submit" class="btn btn-danger btn-sm" style="width: 100px; height: 30px;">Delete</button>
                            </form>
