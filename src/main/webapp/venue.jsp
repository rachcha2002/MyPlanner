...
document.getElementById("submitlink").addEventListener("click", function(event) {
    ...
    <section class="section-1" id="sec1">
        ...
        <div class="rightside">
          <h1>Add Your Venue Here!</h1><br>
            <form action="insertvenue" method="post">
            <input type="hidden" id="id" name="vid">
            <label for="vname">Venue Name</label>
            <input type="text" class="package" id="vnm" name="vname"><br>
            <label for="loc">Location</label>
            <input type="text" class="package" id="loc" name="vlocation"><br>
            <label for="owner">Owner</label>
            <input type="text" class="package" id="own" name="vowner"><br>
            <label for="cap">Seating Capacity</label>
            <input type="text" class="price" id="scap" name="vcapacity"><br>
            <label for="price">Price</label>
            <input type="text" class="price" id="amount" name="vprice"><br>
            <label for="description">Description(Brief description about the location)</label><br>
            <textarea class="description" id="des" name="vdes" rows="5" cols="50"></textarea><br>
            <label for="webpage">Add your website here</label>
            <input type="url" class="price" id="webpage" name="vlink"><br><br>
