...
<section class="section-3" id="sec1">
        ...
        <div class="u-container-layout-1">
            ...
            <h2 class="u-text-2">Venues</h2><br>
...
<section class="section-1" id="sec1">
    ...
    <c:forEach var="v" items="${vDetails}">
        <c:set var="vid" value="${v.vid}"/>
        <c:set var="vname" value="${v.vname}"/>
        <c:set var="location" value="${v.location}"/>
        <c:set var="owner" value="${v.owner}"/>
        <c:set var="seating" value="${v.seating}"/>
        <c:set var="price" value="${v.price}"/>
        <c:set var="description" value="${v.description}"/>
        <c:set var="link" value="${v.link}"/>
          ...
          <div class="event">
            ...
            <div class="details">
              ...
              <h4 class="p1">Venue Name : ${v.vname}</h4>
              <h4 class="p1">Location : ${v.location}</h4>
              <h4 class="p1">Owner  : ${v.owner}</h4>
              <h4 class="p1">Capacity : ${v.seating}</h4>
              <h4 class="p1">Price : Rs. : ${v.price}</h4>
              <h4 class="p1">Description : ${v.description}</h4>
              <h4 class="p1">Web Link : ${v.link}</h4>
          <br>
         
         
         <c:url value="updateVenueProfile.jsp" var="venupdate">
            <c:param name="vid" value="${vid}"></c:param>
            <c:param name="vname" value="${vname}"></c:param>
            <c:param name="location" value="${location}"></c:param>
            <c:param name="owner" value="${owner}"></c:param>
            <c:param name="seating" value="${seating}"></c:param>
            <c:param name="price" value="${price}"></c:param>
            <c:param name="description" value="${description}"></c:param>
            <c:param name="link" value="${link}"></c:param>
          </c:url>
          
          <a href="${venupdate}">
          <input type="button" class="btn" name="update" value="Edit">
          </a><br>
          
          <c:url value="deleteVenue.jsp" var="vendelete">
            <c:param name="vid" value="${vid}"></c:param>
            <c:param name="vname" value="${vname}"></c:param>
            <c:param name="location" value="${location}"></c:param>
            <c:param name="owner" value="${owner}"></c:param>
          ...
          <a href="${vendelete}">
          <input type="button" class="btn" name="delete" value="Delete">
          </a>
