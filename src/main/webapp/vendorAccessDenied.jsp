...
document.getElementById("submitlink").addEventListener("click", function(event) {
    ...
    <section class="section-1" id="sec1">
      ...
      <div class="form-create">
        ...
        <!--Form-->
        <div class="cform">
         <div class="banner>"><h1>In order to use this service you have to login as vendor!</h1></div>
         <p>To access Vendor Portals like Add Venue,My Venues,Add Packages and My Packages you have to login as vendor.</p>

        
         <div class="btn-block">
         <button type="button" id="submitbtn" onclick="window.location.href='vendorlogin.jsp'">Login</button>
         
         <button type="button" id="submitbtn" onclick="window.location.href='home.jsp'">Cancel</button>
