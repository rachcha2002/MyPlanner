    ...
    <div class="container">
        ...
        <form action="registervendor" method="post">
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="venue" name="services[]" value="Venue Services">
                    <label class="form-check-label" for="venue">Venue Services</label>
                </div>
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="photography" name="services[]" value="Photography">
