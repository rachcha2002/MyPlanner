...
document.getElementById("submitlink").addEventListener("click", function(event) {
    ...
    <section class="section-1" id="sec1">
      ...
      <div class="form-create">
        ...
        <!--Form-->
        <div class="cform">
         <div class="banner>"><h1>In order to use this service you have to login as client!</h1></div>
         <p>To access Customer Service like Booking Consultation and Create Event you have to login as normal user.</p>

        
         <div class="btn-block">
         <button type="button" id="submitbtn" onclick="window.location.href='clientlogin.jsp'">Login</button>
