...
document.getElementById("submitlink").addEventListener("click", function(event) {
	...
	%>
        <!--Form-->
        <div class="cform">
         <div class="banner>"><h1>Are you sure you want to delete  <%=name%> event?</h1></div>
         <p>After this crate a event planing process will not be continued by us regarding this event.</p>
