...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/vendorHome.css">
...
document.getElementById("submitlink").addEventListener("click", function(event) {
    ...
    <section class="section-1" id="sec1">
        <center>
            <div class="u-container-layout-1">
                <center>
                <h2 class="u-text-2">Welcome Partner!</h2><br>
                <h3 class="u-text-1">As Event Industry business owner conqure the world with your brand.</h3>
            </center>
              </div>
            </center>   
    </section>
  ...
  <div class="sec2-container" id="about">
    <div class="sec2-img">
     <img src="Images/venue11.jpg" class="w3-round w3-image w3-opacity-min" alt="Table Setting" width="400" height="500">
    </div>

    <div class="sec2-des">
      <h1 class="w3-center">Add Venue</h1><br>
      
      <p class="w3-large">Are you a prestigious venue owner that available for event hosting.Add your venue here get bookings from our customers.</p>
      <br><br>
      <a href="venue.jsp" class="u-btn-1">Add Venue</a>  
    ...
    <section class="section-3" id="sec1">
       
            <div class="u-container-layout-1">
                
                <h2 class="u-text-2">"Alone we can do so little; together we can do so much."</h2><br>
                <h3 class="u-text-1">Helen Keller</h3>
            
              </div>
               
    </section>

    <section class="section-4" id="sec">
        
        <!-- Create Section -->
  <div class="sec2-container" id="about">
    <div class="sec2-des">
        <h1 class="w3-center">Add Event Service</h1><br>
        
        <p class="w3-large">Are you a trustworthy event service (Catering,Photogrphy,Music,Decoration,Lights and sound) provider.Add your services here get bookings from our customers.</p>
        <br><br>
        <a href="package.jsp" class="u-btn-1">Add Service</a>  
         
      </div>
        <div class="sec2-img">
         <img src="Images/dj.jpg" class="w3-round w3-image w3-opacity-min" alt="Table Setting" width="400" height="500">
        </div>
        ...
        <section class="section-5" id="sec">
            <div class="brandstext">
                <center>
                <h1 class="brandtheme">Our Most Polpular Patners</h1>
            </center>
            </div>
            <div class="brands">
         <a href="https://www.jetwinghotels.com/#gref" > <img src="Images/jetwing.jpg" class="w3-round w3-image w3-opacity-min" alt="Table Setting" width="200" height="200"></a>
         <a href="https://lassana.com/" ><img src="Images/lassana.jpg" class="w3-round w3-image w3-opacity-min" alt="Table Setting" width="300" height="200"></a>
          <a href="https://www.facebook.com/alumkacaterers/" > <img src="Images/alumka.png" class="w3-round w3-image w3-opacity-min" alt="Table Setting" width="200" height="200"></a>
             <a href="https://dynamicavtechnologies.com/" ><img src="Images/dynamic.jpg" class="w3-round w3-image w3-opacity-min" alt="Table Setting" width="200" height="200"></a>s
        </div>
        </section>
