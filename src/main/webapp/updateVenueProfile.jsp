        ...
        <div class="rightside">
          <h1>Venue Details</h1><br>
           ...
           %>
            ...
            <input type="text" class="package" id="vnm" name="vname" value="<%=vname%>"><br>
            <label for="loc">Location</label>
            <input type="text" class="package" id="loc" name="vlocation" value="<%=location%>"><br>
            <label for="owner">Owner</label>
            <input type="text" class="package" id="own" name="vowner" value="<%=owner%>"><br>
            <label for="cap">Seating Capacity</label>
            <input type="text" class="price" id="scap" name="vcapacity" value="<%=seating%>"><br>
            <label for="price">Price</label>
            <input type="text" class="price" id="amount" name="vprice" value="<%=price%>"><br>
            <label for="description">Description(Brief description about the location)</label><br>
            <textarea class="description" id="des" name="vdes" rows="5" cols="50"><%=description%></textarea><br>
            <label for="webpage">Add your website here</label>
            <input type="url" class="price" id="webpage" name="vlink" value="<%=link%>"><br><br>
