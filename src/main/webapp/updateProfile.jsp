...
document.getElementById("submitlink").addEventListener("click", function(event) {
    ...
    <section class="section-1" id="sec1">
      ...
      <div class="rightside">
        ...
        <form action="updatepkg" method="post">
          Package ID :
          <input type="text" name="pid" value="<%=pid%>" readonly><br>
          Package Name :
          <input type="text" class="package" name="Pname" value="<%=pname%>"><br><br>
          ...
          Price :
          <input type="text" class="price" name="Pprice" value="<%=price %>"><br><br>
          Description(Brief description about the package) :
          <textarea class="description" name="Pdes" rows="5" cols="50"><%=description %></textarea><br><br>
