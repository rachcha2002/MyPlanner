...
document.getElementById("submitlink").addEventListener("click", function(event) {
    ...
    <section class="section-1" id="sec1">
        ...
        %>
            ...
            <input type="text" class="price" id="vid" name="vid" value="<%=vid %>" readonly><br>
            <label for="vname">Venue Name :</label>
            <input type="text" class="package" id="vnm" name="vname" value="<%=vname%>" readonly><br>
            <label for="loc">Location</label>
            <input type="text" class="package" id="loc" name="vlocation" value="<%=location%>" readonly><br>
            <label for="owner">Owner</label>
            <input type="text" class="package" id="own" name="vowner" value="<%=owner%>" readonly><br>
            <label for="cap">Seating Capacity</label>
            <input type="text" class="price" id="scap" name="vcapacity" value="<%=seating%>" readonly><br>
            <label for="price">Price</label>
            <input type="text" class="price" id="amount" name="vprice" value="<%=price%>" readonly><br>
            <label for="description">Description(Brief description about the location)</label><br>
            <textarea class="description" id="des" name="vdes" rows="5" cols="50" readonly><%=description%></textarea><br>
            <label for="webpage">Add your website here</label>
            <input type="url" class="price" id="webpage" name="vlink" value="<%=link%>" readonly><br><br>
