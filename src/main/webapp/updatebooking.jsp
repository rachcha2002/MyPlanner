    ...
    <div class="container">
        ...
        <form action="updatebooking" method="post"> 
            ...
            <div class="form-group">
                ...
                <input type="hidden" class="form-control" id="client_id" name="client_id" value="<%=client_username%>" readonly>
            </div>
            <div class="form-group">
                <label for="hotel">Hotel:</label>
                <input type="text" class="form-control" id="hotel" name="hotel" value="<%=rname%>">
            </div>
            <div class="form-group">
                <label for="hall">Event Hall:</label>
                <input type="text" class="form-control" id="hall" name="hall" value="<%=venue%>">
            </div>
            <div class="form-group">
