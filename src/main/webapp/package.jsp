...
document.getElementById("submitlink").addEventListener("click", function(event) {
    ...
    <section class="section-1" id="sec1">
      ...
      <div class="rightside">
        <h1>Create Your Package Here!</h1><br>
        <form action="add" method="post">
          <label for="package">Package Name</label>
          <input type="text" class="package" id="pkg" name="pname"><br><br>
          ...
          <input type="text" class="price" id="amount" name="pprice"><br><br>
          <label for="description">Description(Brief description about the package)</label><br>
          <textarea class="description" id="des" name="pdes" rows="5" cols="50"></textarea><br><br>
