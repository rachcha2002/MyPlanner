    ...
    <div class="row justify-content-center mt-5">
        <div class="col-md-6">
            ...
            <div class="mt-3 text-center">
                <a href="vendorlogin.jsp"><button class="btn btn-primary">Login as Vendor</button></a>
            </div>
            
            <div class="mt-3 text-center">
                <a href="addnewclient.jsp"><button class="btn btn-success">Create New Account</button></a>
            </div>
        </div>
    </div>
</div>
