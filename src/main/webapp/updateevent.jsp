...
document.getElementById("submitlink").addEventListener("click", function(event) {
	...
	%>
        ...
        <form  action="update" method="post">
          <h1>Edit Event</h1>
          <div class="item">
              <label for="ename">Event Name(You cannot change the name)</label>
              <input id="ename" type="text" name="ename" value="<%= name %>" readonly/>
            </div>
          <div class="item">
          <label for="edate">Event Date*</label>
            <input type="date" name="edate" value="<%= date %>" required/>
            <i class="fas fa-calendar-alt"></i>
          </div>
          <div class="item">
              <label for="etime">Event Time*</label>
            <input type="text" name="etime" value="<%= time %>" required/>
            <i class="fas fa-clock"></i>
          </div>
          <div class="item">
              <label for="participation">Number of Guests*</label>
              <input id="participation" type="number" name="participation" value="<%= guestCount %>" required/>
          </div>
          <div class="item">
              <label for="hostname">Host Name*</label>
              <input id="hostname" type="text" name="hostname" value="<%= hostName %>" required/>
          </div>
          ...
          <div class="item">
              ...
              <input id="budget" type="number" name="budget" value="<%= budget %>" required/>
          </div>
          <div class="item">
              <label for="vname">Venue*</label>
              <input type="text" name="vname" value="<%= venue %>" required/>
          ...
          <div class="city-item">
              ...
              <select name="decoration" style="width:120px;">
                  <option value="<%= deco %>"><%= photo %></option>
                  <option value="none">None</option>
                  <option value="Customize">Custom</option>
                  <option value="initial">Initial</option>
                <option value="bestselling">Best Selling</option>
              ...
              <select name="light&audio" style="width:120px;">
                  <option value="<%= lights %>"><%= photo %></option>
                  <option value="none">None</option>
                  <option value="Customize">Custom</option>
                  <option value="initial">Initial</option>
                <option value="bestselling">Best Selling</option>
              ...
              <select name="catering" style="width:120px;">
                  <option value="<%= catering %>"><%= photo %></option>
                  <option value="none">None</option>
                  <option value="Customize">Custom</option>
                  <option value="initial">Initial</option>
                <option value="bestselling">Best Selling</option>
          ...
          <div class="item">
            ...
            <textarea rows="8" name="des" ><%= des %></textarea>
          </div>
          ...
          <div class="item">
              ...
              <div class="name-item">
            <input type="text" name="pnumber" value="<%= number %>" minlength="10" maxlength="10" required/>
          </div>
          </div>
          <div class="item">
            <label for="eid">Event ID</label>
            <div class="name-item">
          <input type="text" name="eid" value="<%= id %>" readonly/>
        </div>
        </div>
      ...
      <div class="logpic">
        <img src="Images/music3.jpg" class="loginpic">
        <div class="quote">
            
            <p>Edit your preferences heart out.We will make you a plan of dreaming.</p>
