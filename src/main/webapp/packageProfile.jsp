...
<section class="section-3" id="sec1">
        ...
        <div class="u-container-layout-1">
            ...
            <h2 class="u-text-2">Packages</h2><br>
...
<section class="section-1" id="sec1">
    ...
    <c:forEach var="p" items="${pDetails}">
          ...
          <c:set var="pcategory" value="${p.pcategory}" />
          <c:set var="ptype" value="${p.ptype}"/>
          <c:set var="price" value="${p.price}"/>
          <c:set var="description" value="${p.description}"/>
          <div class="faq">
          <div class="event">
            <h3>${p.pname}</h3>
            <div class="details">
              ...
              <h4 class="p1">Package Name : ${p.pname}</h4>
              <h4 class="p1">Package Category : ${p.pcategory}</h4>
              <h4 class="p1">Package Type  : ${p.ptype}</h4>
              <h4 class="p1">Package Price : Rs. ${p.price}</h4>
              <h4 class="p1">Package Description :<br>${p.description}</h4>
          <br>
         ...
         <c:url value="updateProfile.jsp" var="profupdate">
            ...
            <c:param name="pcategory" value="${pcategory}"></c:param>
            <c:param name="ptype" value="${ptype}"></c:param>
          ...
          <c:url value="deleteProfile.jsp" var="profdelete">
             <c:param name="pid" value="${pid}"></c:param>
            <c:param name="pname" value="${pname}"></c:param>
            <c:param name="pcategory" value="${pcategory}"></c:param>
            <c:param name="ptype" value="${ptype}"></c:param>
