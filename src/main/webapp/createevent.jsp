      ...
      <div class="formcreate">
        ...
        <form  action="insert" method="post">
          ...
          <div class="item">
            ...
            <input type="text" name="etime" placeholder="00:00 AM" required/>
            <i class="fas fa-clock"></i>
          </div>
          <div class="item">
              <label for="participation">Number of Guests*</label>
              <input id="participation" type="number" name="participation" required/>
          </div>
          <div class="item">
          ...
          <div class="item">
            ...
            <textarea rows="8" name="des"></textarea>
          </div>
          ...
          <div class="item">
              ...
              <div class="name-item">
            <input type="text" name="pnumber" placeholder="Contact Number" minlength="10" maxlength="10" required/>
          </div>
          </div>
