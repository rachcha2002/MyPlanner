...
public class venueServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       if(usertype=="Vendor") {
		...
		isTrue = venueDBUtil.insertDetails(vname,location,owner,seating,price,description,link,uname);
		...
		if(isTrue == true) {
			...
			String successMessage="Venue Creation Successfully.";
			...
			out.println("alert('Venue creation unsuccesful! Try Again');");
			out.println("location='venue.jsp'");
			out.println("</script>");
		}
	}
